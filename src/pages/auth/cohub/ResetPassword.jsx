// src/pages/auth/cohub/ResetPassword.jsx
...
export default function CohubResetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post(`${BASE_URL}/api/auth/cohub/reset-password/${token}`, { password });
